                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-6">
                        <ul class="chart-list-out">
                            <li><span class="circle-blue"></span>Docentes</li>
        ...
        <div class="card card-chart">
            <div class="card-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-6">
                        <ul class="chart-list-out">
                            <li><span class="circle-blue"></span>Hembras</li>
                            <li><span class="circle-green"></span>Varones</li>
                            <li class="star-menus"><a href="javascript:;"><i class="fas fa-ellipsis-v"></i></a>
                            </li>
                        </ul>
                    </div>
...
<div class="row">
    <div class="col-xl-6 d-flex">
        ...
        <div class="card flex-fill student-space comman-shadow">
            <div class="card-header d-flex align-items-center">
                <h5 class="card-title">Estudiantes Destacados</h5>
    ...
    <div class="col-xl-6 d-flex">
        ...
        <div class="card flex-fill comman-shadow">
            <div class="card-header d-flex align-items-center">
                <h5 class="card-title ">Actividad del Estudiante </h5>
                <ul class="chart-list-out student-ellips">
                    <li class="star-menus"><a href="javascript:;"><i class="fas fa-ellipsis-v"></i></a>
                    </li>
                </ul>
